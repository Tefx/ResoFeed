...
- a moving image reference, optional Compose image fallback, incomplete OCI index/platform/revision chain, or absent platform commit-label verification;
